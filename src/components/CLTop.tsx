    ...
    return (
        <Container className='cs-w cs-bg-vector text-center d-flex flex-column align-items-center gap-3 py-5'>
            ...
            <ButtonGroup className='gap-3'>
                <Button className='cs-tc-one cs-transition border-0 rounded rounded-3 bg-transparent cs-btn'>All Products</Button>
                <Button className='cs-tc-one cs-transition border-0 rounded rounded-3 bg-transparent cs-btn'>Available Now</Button>
            </ButtonGroup>
        </Container>
    );
}
