...
const CLTop: FC<CLTopProps> = ({ setAvailableFilter }) => {
    return (
        <Container className='cs-w cs-bg-vector text-center d-flex flex-column align-items-center gap-3 py-5'>
            <h1 className='user-select-none cs-tc-one'>Our Collection</h1>
            <p className='user-select-none cs-tc-two'>Introducing our Coffee Collection, a selection of unique coffees
